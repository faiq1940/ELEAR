...
<div class="background-image">
    <img src="{{ asset('images/tangan.webp') }}" alt="background" class="tangan">
    <div class="container">
        @if (session('success'))
        ...
        <div class="login-card">
            <div class="login-form">
                <div class="header">
                    ...
                    <p class="description">Login Akun Mahasiswa dan Dosen</p>
                </div>

                <form method="POST" action="{{ url('/login') }}" class="login-form-fields">
                    @csrf
                    ...
                    <div class="input_container">
                        ...
                        <input id="email_field" class="input_field" type="text" name="name" title="Input title" placeholder="nama lengkap" required>
                    </div>
                    ...
                    <div class="input_container">
                        ...
                        <input id="password_field" class="input_field" type="password" name="password" title="Inpit title" placeholder="Password" required>
                    </div>

                    <div class="input_container">
                        <select class="input_field role_select" name="role" title="Pilih role" required>
            ...
            <div class="testimonial">
                <img class="testimonial_img" src="{{ asset('images/book.webp') }}" alt="Testimonial Image">
            </div>
        </div>
    </div>
</div>
